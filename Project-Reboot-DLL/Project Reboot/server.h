...
namespace Server
{
	...
	namespace Hooks
	{
		...
		// Forces MCP profile requests to dispatch as CXC_Public so the server can read player profiles.
		void* SendRequestNow(void* Arg1, void* MCPData, int ContextCredentials);
